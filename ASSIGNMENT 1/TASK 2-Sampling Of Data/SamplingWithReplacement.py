...
def SampleOnce():
    ...
    while (1):
        DataObject = random.choices(Data,k=1)
        Output+=1
...
def Graph1():
    ...
    plt.title('Sample Size Vs Probability Graph (With Replacement) For Given K') 
    plt.show() 
...
def Graph2():
    ...
    plt.title('Sample Size Vs Frequncy Graph (With Replacement) For Given K') 
    plt.show()
